...
The repository is being delivered feature-by-feature. The current implementation includes the project foundation and authentication backend. The canonical implementation roadmap is maintained in [`docs/PROJECT_EXECUTION_PLAN.md`](docs/PROJECT_EXECUTION_PLAN.md).
